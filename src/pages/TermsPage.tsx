...
const Section = ({ title, text }: { title: string; text: string }) => (
  <div style={{ marginBottom: '24px' }}>
    <h4 style={{ fontWeight: 'bold', color: '#111827', fontSize: '16px' }}>{title}</h4>
    <p style={{ whiteSpace: 'pre-line', color: '#4B5563', fontSize: '14px', marginTop: '8px' }}>{text}</p>
  </div>
);
